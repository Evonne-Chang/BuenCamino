...
tl.from('#event01', .8, {x:-120, opacity: 0, ease: Power4.easeInOut}, "=-.5");
tl.from('#event02', .8, {x:120, opacity: 0, ease: Power2.easeInOut}, "=-.7");
tl.from('#etext01', .6, {y:-180, opacity: 0, ease: Power2.easeInOut}, "=-.7");
tl.from('#etext02', .6, {y:180, opacity: 0, ease: Power4.easeInOut}, "=-.7");
